...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/CpuJP/AppInventarioBack
   ```
...
- **inventories**: stores each item in a separate inventory
- **status**: stores the status of each item
- **audits**: stores each movement that is made in the other tables
